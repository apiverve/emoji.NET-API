...
namespace APIVerve
{
    public class EmojiAPIClient
    {
        ...
        public EmojiAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public EmojiAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, emojiQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(emojiQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(emojiQueryOptions options)
        {
